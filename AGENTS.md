...
2. `TASK.md`
3. `README.md`
4. repository source, scripts, tests, logs, and artifacts relevant to the task
...
- Do not modify Zoho runtime systems, production systems, external GitHub configuration, or customer data unless explicitly approved.
- Do not delete, overwrite, or rewrite existing work without explicit approval.
- Preserve uncommitted and untracked work you did not create.

## Commit and Push Rules

- Do not commit or push unless explicitly approved.
- Keep changes bounded, reviewable, and scoped to this repository.
- Do not commit credentials, generated caches, logs, local state, private customer data, or credential-bearing URLs.
